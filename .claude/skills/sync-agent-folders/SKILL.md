...
The `brunolm-code-review` skill at [common/.claude/skills/brunolm-code-review/SKILL.md](../../../common/.claude/skills/brunolm-code-review/SKILL.md) is a good worked example of these transforms.
