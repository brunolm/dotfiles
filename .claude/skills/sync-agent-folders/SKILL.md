...
The `b-code-review` skill at [common/.claude/skills/b-code-review/SKILL.md](../../../common/.claude/skills/b-code-review/SKILL.md) is a good worked example of these transforms.
